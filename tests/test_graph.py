...
def test_render_graph_with_data() -> None:
    ...
    with patch("src.graph.plt") as mock_plt:
        ...
        mock_plt.title.assert_called_with("Daily Caffeine & Sugar Intake")
...
def test_render_graph_date_formatting() -> None:
    ...
    with patch("src.graph.plt") as mock_plt:
        ...
        call_args = mock_plt.multiple_bar.call_args
        dates = call_args[0][0]
        assert dates == ["12-27"]
...
def test_render_graph_multiple_dates() -> None:
    ...
    with patch("src.graph.plt") as mock_plt:
        ...
        assert values == [[100, 150, 200], [30, 40, 50]]  # [caffeine, sugar]
